...
## 🚀 Key Features
- **Offline-First Data Entry:** Local accounting for milk collection and processing.
- **Blockchain Anchoring:** Daily production batches are hashed and anchored to Polygon Mainnet for tamper-proof transparency.
- **Public Audit Trail:** Consumers and donors can verify the origin and quality of each batch via public block explorers.
- **Impact Tracking:** Real-time monitoring of cooperative revenue and youth employment metrics.

## 🛠 Tech Stack
- **Core:** ERPNext / Frappe Framework
